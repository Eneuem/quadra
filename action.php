...
<head>
    ...
    <link rel="shorcut icon" type="img/png" href="img/getflix-icone.png">
...
<body>
    ...
    <section id="hero">
        ...
        <!-- Nav Container -->
        <nav class="relative  mx-auto p-2  bg-gray-800 bg-opacity-30">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="hidden items-center space-x-6 font-bold text-yellow-400 lg:flex">
                    ...
                    <div class="items-center space-x-6 font-bold text-yellow-400 lg:flex">
                        ...
                        <a href="#" id="signupBtn" class="px-4 py-1 font-bold text-lime-100 bg-yellow-400 rounded-xl hover:opacitw-full">Sign Up</a>
