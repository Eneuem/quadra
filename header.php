    ...
    <nav class="sticky top-0 mx-auto p-2 bg-gray-900 backdrop-blur-sm z-40 rounded-md ">
        ...
        <div class="flex items-center justify-between">
                ...
                <div>
                    <form action="php/search.php" method="GET" id="searchForm">
                        <div class="relative flex items-center">
                            <input type="text" id="search" name="search" class="w-[80%] lg:w-96 h-10 shadow p-4 pl-10 pr-10 rounded-full placeholder-text-yellow-400 bg-gray-600 focus:bg-white focus:text-gray-600 focus:placeholder-transparent relative" placeholder="Find Movies & TV" required autocomplete="off" />
            ...
            <div class="hidden items-center space-x-6 font-bold text-yellow-400 lg:flex">
                <div class=" hidden space-x-8 font-bold lg:flex">
                    ...
                    <a href="index.php?page=new_movie">Coming Soon</a>
        ...
        <div id="menu" class="absolute hidden p-4 mt-2 bg-gray-900 left-6 right-6 top-20 rounded-md z-50">
            <div class="flex flex-col items-center justify-center w-full space-y-6 font-bold text-yellow-400 rounded-md">
                <!-- Reproduction des liens du menu de bureau -->
                <a href="index.php?page=subscription" class="w-full text-center">Membership</a>
                <a href="index.php?page=seances" class="w-full text-center">What's On</a>
                <a href="#" class="w-full text-center">Coming Soon</a>
                <!-- Fin de la reproduction des liens -->

                <!-- Liens existants -->
                <a href="index.php?page=signup" id="signupBtn-mobile" class="w-full text-center rounded-md px-full py-1 bg-yellow-400 text-lime-100">Sign Up</a>
                <a href="index.php?page=login" id="loginBtn-mobile" class="w-full text-center rounded-md">Login</a>
