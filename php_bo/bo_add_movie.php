...
<div>
    <form id="searchForm" action="api_search.php" method="GET">
        <div class="flex relative">
            <input type="text" id="search" name="search" class="w-full border h-10 shadow p-4 pl-10 pr-10 text-black rounded-full placeholder:font-thin" placeholder="Find Movies & TV" required />
            ...
            <ul id="searchResults" class="absolute bg-gray-900 mt-10 rounded-md text-gray-300 p-2"></ul>
        </div>
    </form>
</div>
</div>
