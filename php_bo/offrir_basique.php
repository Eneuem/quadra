...
if (isset($_POST['userId'])) {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO abonnements (user_id, type_abonnement, est_paye, date_debut, date_fin) VALUES (:user_id, :type_abonnement, 1, :date_debut, :date_fin) ON DUPLICATE KEY UPDATE type_abonnement = :type_abonnement, est_paye = 1, date_debut = :date_debut, date_fin = :date_fin");
        ...
        echo "Abonnement premium offert avec succès.";
