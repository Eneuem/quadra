            ...
            <div class="flex flex-col">
                <div class="flex items-center">
                    ...
                    <form id="wishlistForm" action='wishlist_process.php' method='post'>
                        ...
                        <label for="favorite" class="material-symbols-outlined cursor-pointer ml-2 mr-2" style="font-variation-settings:'FILL' 0;transition: filter 0.3s;" onclick="document.getElementById('wishlistForm').submit();">
