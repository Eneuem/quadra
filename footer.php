...
<footer class="p-4 sm:p-4 bg-slate-950 w-full">
    <div class="mx-auto max-w-screen-2xl">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-white sm:text-center ">© 2023 <a href="index.php" class="hover:underline">QuadraStream™</a>. All Rights Reserved.
            </span>
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="_target" class="text-white hover:text-blue-700 ">
